...
namespace Discord.Interactions
{
        ...
        where T : class, IInteractionContext
    {
        ...
        /// </returns>
        /// <exception cref="InvalidOperationException">Thrown if the interaction isn't a type of <see cref="RestInteraction"/>.</exception>
        protected override Task RespondWithModalAsync<TModal>(string customId, TModal modal, RequestOptions? options = null, Action<ModalBuilder>? modifyModal = null)
            => HandleInteractionAsync(x => x.RespondWithModal(customId, modal, options, modifyModal));
