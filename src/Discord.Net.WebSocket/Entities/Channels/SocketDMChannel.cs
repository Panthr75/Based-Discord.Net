...
namespace Discord.WebSocket
{
    ...
    public class SocketDMChannel : SocketChannel, IDMChannel, ISocketPrivateChannel, ISocketMessageChannel
    {
        ...
        IAsyncEnumerable<IReadOnlyCollection<IMessage>> IMessageChannel.GetMessagesAsync(int limit, CacheMode mode, RequestOptions? options)
            => mode == CacheMode.CacheOnly ? AsyncEnumerable.Empty<IReadOnlyCollection<IMessage>>() : GetMessagesAsync(limit, options);
        /// <inheritdoc />
        IAsyncEnumerable<IReadOnlyCollection<IMessage>> IMessageChannel.GetMessagesAsync(ulong fromMessageId, Direction dir, int limit, CacheMode mode, RequestOptions? options)
            => mode == CacheMode.CacheOnly ? AsyncEnumerable.Empty<IReadOnlyCollection<IMessage>>() : GetMessagesAsync(fromMessageId, dir, limit, options);
        /// <inheritdoc />
        IAsyncEnumerable<IReadOnlyCollection<IMessage>> IMessageChannel.GetMessagesAsync(IMessage fromMessage, Direction dir, int limit, CacheMode mode, RequestOptions? options)
            => mode == CacheMode.CacheOnly ? AsyncEnumerable.Empty<IReadOnlyCollection<IMessage>>() : GetMessagesAsync(fromMessage.Id, dir, limit, options);
        /// <inheritdoc />
