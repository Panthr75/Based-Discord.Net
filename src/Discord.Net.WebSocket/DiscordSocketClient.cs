                            ...
                            case "VOICE_CHANNEL_STATUS_UPDATE":
                                {
                                    ...
                                    var data = ((JsonElement)payload!).Deserialize<VoiceChannelStatusUpdateEvent>(_serializerOptions)!;
                                    var guild = State.GetGuild(data.GuildId);
                            ...
                            case "ENTITLEMENT_CREATE":
                                {
                                    ...
                                    var data = ((JsonElement)payload!).Deserialize<Entitlement>(_serializerOptions)!;
                            ...
                            case "ENTITLEMENT_UPDATE":
                                {
                                    ...
                                    var cacheableBefore = new Cacheable<SocketEntitlement, ulong>(entitlement?.Clone(), data.Id,
                                        entitlement is not null, () => Task.FromResult<SocketEntitlement?>(null));
