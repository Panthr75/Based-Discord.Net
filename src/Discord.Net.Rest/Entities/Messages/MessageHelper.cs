...
namespace Discord.Rest
{
    internal static class MessageHelper
    {
        ...
        public static Task DeleteAsync(IMessage msg, BaseDiscordClient client, RequestOptions? options = null)
            => DeleteAsync(msg.Channel.Id, msg.Id, client, options);

        public static Task DeleteAsync(ulong channelId, ulong msgId, BaseDiscordClient client,
            RequestOptions? options)
            => client.ApiClient.DeleteMessageAsync(channelId, msgId, options);

        public static Task AddReactionAsync(ulong channelId, ulong messageId, IEmote emote, BaseDiscordClient client, RequestOptions? options = null)
            => client.ApiClient.AddReactionAsync(channelId, messageId, emote is Emote e ? $"{e.Name}:{e.Id}" : UrlEncode(emote.Name!), options);

        public static Task AddReactionAsync(IMessage msg, IEmote emote, BaseDiscordClient client, RequestOptions? options = null)
            => client.ApiClient.AddReactionAsync(msg.Channel.Id, msg.Id, emote is Emote e ? $"{e.Name}:{e.Id}" : UrlEncode(emote.Name!), options);

        public static Task RemoveReactionAsync(ulong channelId, ulong messageId, ulong userId, IEmote emote, BaseDiscordClient client, RequestOptions? options = null)
        ...
        public static Task RemoveReactionAsync(IMessage msg, ulong userId, IEmote emote, BaseDiscordClient client, RequestOptions? options = null)
        ...
        public static Task RemoveAllReactionsAsync(ulong channelId, ulong messageId, BaseDiscordClient client, RequestOptions? options = null)
            => client.ApiClient.RemoveAllReactionsAsync(channelId, messageId, options);

        public static Task RemoveAllReactionsAsync(IMessage msg, BaseDiscordClient client, RequestOptions? options = null)
            => client.ApiClient.RemoveAllReactionsAsync(msg.Channel.Id, msg.Id, options);

        public static Task RemoveAllReactionsForEmoteAsync(ulong channelId, ulong messageId, IEmote emote, BaseDiscordClient client, RequestOptions? options = null)
        ...
        public static Task RemoveAllReactionsForEmoteAsync(IMessage msg, IEmote emote, BaseDiscordClient client, RequestOptions? options = null)
        ...
        public static IAsyncEnumerable<IReadOnlyCollection<IUser>> GetReactionUsersAsync(IMessage msg, IEmote emote,
            int? limit, BaseDiscordClient client, ReactionType reactionType, RequestOptions? options = null)
        {
        ...
        public static Task PinAsync(IMessage msg, BaseDiscordClient client,
            RequestOptions? options)
        {
        ...
        public static Task UnpinAsync(IMessage msg, BaseDiscordClient client,
            RequestOptions? options)
        ...
        {
            userMentions ??= ImmutableArray<IUser>.Empty;
        ...
        public static ImmutableArray<T> FilterTagsByValue<T>(TagType type, ImmutableArray<ITag> tags)
        {
            return tags
                .Where(x => x.Type == type)
                .Select(x => (T)x.Value!) // null supress due to null check
                .Where(x => x != null)
                .ToImmutableArray();
        }
        ...
        public static Task CrosspostAsync(IMessage msg, BaseDiscordClient client, RequestOptions? options = null)
            => CrosspostAsync(msg.Channel.Id, msg.Id, client, options);

        public static Task CrosspostAsync(ulong channelId, ulong msgId, BaseDiscordClient client,
            RequestOptions? options)
