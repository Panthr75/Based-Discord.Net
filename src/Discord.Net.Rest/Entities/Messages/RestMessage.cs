...
namespace Discord.Rest
{
    ...
    public abstract class RestMessage : RestEntity<ulong>, IMessage, IUpdateable
    {
        ...
        /// <inheritdoc />
        public IAsyncEnumerable<IReadOnlyCollection<IUser>> GetReactionUsersAsync(IEmote emote, int limit, RequestOptions? options = null, ReactionType reactionType = ReactionType.Normal)
            => MessageHelper.GetReactionUsersAsync(this, emote, limit, Discord, reactionType, options);
    }
}
