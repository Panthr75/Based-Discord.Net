...
namespace Discord.Rest
{
    internal static class GuildHelper
    {
        ...
        public static Task<Model> ModifyAsync(IGuild guild, BaseDiscordClient client,
            Action<GuildProperties> func, RequestOptions? options = null)
        {
        ...
        public static Task<WidgetModel> ModifyWidgetAsync(IGuild guild, BaseDiscordClient client,
            Action<GuildWidgetProperties> func, RequestOptions? options = null)
        {
            Preconditions.NotNull(func, nameof(func));
        ...
        public static Task ReorderChannelsAsync(IGuild guild, BaseDiscordClient client,
            IEnumerable<ReorderChannelProperties> args, RequestOptions? options = null)
        {
        ...
        public static Task<IReadOnlyCollection<RoleModel>> ReorderRolesAsync(IGuild guild, BaseDiscordClient client,
            IEnumerable<ReorderRoleProperties> args, RequestOptions? options = null)
        {
            Preconditions.NotNull(args, nameof(args));
        ...
        public static Task LeaveAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
            => client.ApiClient.LeaveGuildAsync(guild.Id, options);

        public static Task DeleteAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
        ...
        public static async Task<GuildIncidentsData> ModifyGuildIncidentActionsAsync(IGuild guild, BaseDiscordClient client, Action<GuildIncidentsDataProperties> func, RequestOptions? options = null)
        {
            ...
            var args = props.DmsDisabledUntil.IsSpecified || props.InvitesDisabledUntil.IsSpecified
                ...
                : new ModifyGuildIncidentsDataParams();
        ...
        public static async Task<RestBan?> GetBanAsync(IGuild guild, BaseDiscordClient client, ulong userId, RequestOptions? options = null)
        {
        ...
        public static Task AddBanAsync(IGuild guild, BaseDiscordClient client,
            ulong userId, int pruneDays, string? reason, RequestOptions? options = null)
        {
            var args = new CreateGuildBanParams { DeleteMessageDays = pruneDays, Reason = Optional.CreateFromNullable(reason) };
            return client.ApiClient.CreateGuildBanAsync(guild.Id, userId, args, options);
        }

        public static Task RemoveBanAsync(IGuild guild, BaseDiscordClient client,
            ulong userId, RequestOptions? options = null)
        ...
        public static async Task<IReadOnlyCollection<RestTextChannel>> GetTextChannelsAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
        {
            var models = await client.ApiClient.GetGuildChannelsAsync(guild.Id, options).ConfigureAwait(false);
            return models
                .Select(x => RestGuildChannel.Create(client, guild, x))
                .OfType<RestTextChannel>()
                .ToImmutableArray();
        }
        public static async Task<IReadOnlyCollection<RestNewsChannel>> GetNewsChannelsAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
        {
            var models = await client.ApiClient.GetGuildChannelsAsync(guild.Id, options).ConfigureAwait(false);
            return models
                .Select(x => RestGuildChannel.Create(client, guild, x))
                .OfType<RestNewsChannel>()
                .ToImmutableArray();
        }
        public static async Task<IReadOnlyCollection<RestThreadChannel>> GetThreadChannelsAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
        {
            var models = await client.ApiClient.GetGuildChannelsAsync(guild.Id, options).ConfigureAwait(false);
            return models
                .Select(x => RestGuildChannel.Create(client, guild, x))
                .OfType<RestThreadChannel>()
                .ToImmutableArray();
        }
        public static async Task<IReadOnlyCollection<RestVoiceChannel>> GetVoiceChannelsAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
        {
            var models = await client.ApiClient.GetGuildChannelsAsync(guild.Id, options).ConfigureAwait(false);
            return models
                .Select(x => RestGuildChannel.Create(client, guild, x))
                .OfType<RestVoiceChannel>()
                .ToImmutableArray();
        }
        public static async Task<IReadOnlyCollection<RestStageChannel>> GetStageChannelsAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
        {
            var models = await client.ApiClient.GetGuildChannelsAsync(guild.Id, options).ConfigureAwait(false);
            return models
                .Select(x => RestGuildChannel.Create(client, guild, x))
                .OfType<RestStageChannel>()
                .ToImmutableArray();
        }
        public static async Task<IReadOnlyCollection<RestForumChannel>> GetForumChannelsAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
        {
            var models = await client.ApiClient.GetGuildChannelsAsync(guild.Id, options).ConfigureAwait(false);
            return models
                .Select(x => RestGuildChannel.Create(client, guild, x))
                .OfType<RestForumChannel>()
                .ToImmutableArray();
        }
        public static async Task<IReadOnlyCollection<RestMediaChannel>> GetMediaChannelsAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
        {
            var models = await client.ApiClient.GetGuildChannelsAsync(guild.Id, options).ConfigureAwait(false);
            return models
                .Select(x => RestGuildChannel.Create(client, guild, x))
                .OfType<RestMediaChannel>()
                .ToImmutableArray();
        }
        public static async Task<IReadOnlyCollection<RestCategoryChannel>> GetCategoryChannelsAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions? options)
        {
            var models = await client.ApiClient.GetGuildChannelsAsync(guild.Id, options).ConfigureAwait(false);
            return models
        ...
        {
            var model = await ChannelHelper.CreateTextChannelAsync(guild.Id, client, name, options, func).ConfigureAwait(false);
        ...
        {
            var model = await ChannelHelper.CreateNewsChannelAsync(guild.Id, client, name, options, func).ConfigureAwait(false);
        ...
        {
            var model = await ChannelHelper.CreateVoiceChannelAsync(guild.Id, client, name, options, func).ConfigureAwait(false);
            return RestVoiceChannel.Create(client, guild, model);
        }
        public static async Task<RestStageChannel> CreateStageChannelAsync(IGuild guild, BaseDiscordClient client,
            string name, RequestOptions? options = null, Action<VoiceChannelProperties>? func = null)
        {
            var model = await ChannelHelper.CreateStageChannelAsync(guild.Id, client, name, options, func).ConfigureAwait(false);
        ...
        {
            var model = await ChannelHelper.CreateCategoryChannelAsync(guild.Id, client, name, options, func).ConfigureAwait(false);
        ...
        {
            var model = await ChannelHelper.CreateForumChannelAsync(guild.Id, client, name, options, func).ConfigureAwait(false);
        ...
        {
            var model = await ChannelHelper.CreateMediaChannelAsync(guild.Id, client, name, options, func).ConfigureAwait(false);
        ...
        public static Task DeleteIntegrationAsync(IGuild guild, BaseDiscordClient client, ulong id,
            RequestOptions? options)
            ...
            RequestOptions? options)
        {
            ...
            if (vanityModel is null || vanityModel.Code is null)
                return null;
        ...
        #region Roles
        /// <exception cref="ArgumentNullException"><paramref name="name"/> is <see langword="null" />.</exception>
        public static Task<RoleModel> CreateRoleAsync(IGuild guild, BaseDiscordClient client,
        ...
        {
            if (name is null)
                return Task.FromException<RoleModel>(new ArgumentNullException(nameof(name)));
            ...
            if (icon is not null || emoji is not null)
            {
                ...
                if (icon is not null && emoji is not null)
                {
                    Task.FromException<RoleModel>(new ArgumentException("Emoji and Icon properties cannot be present on a role at the same time."));
                }
            }
            ...
            return client.ApiClient.CreateGuildRoleAsync(guild.Id, createGuildRoleParams, options);
        }
        #endregion
        ...
        public static async Task<RestGuildUser?> AddGuildUserAsync(IGuild guild, BaseDiscordClient client, ulong userId, string accessToken,
            Action<AddGuildUserProperties>? func, RequestOptions? options = null)
        {
            Preconditions.NotNull(accessToken, nameof(accessToken));
        ...
        public static Task<RestGuildUser?> GetCurrentUserAsync(IGuild guild, BaseDiscordClient client,
            RequestOptions options)
        ...
        public static IAsyncEnumerable<IReadOnlyCollection<RestGuildUser>> GetUsersAsync(IGuild guild, BaseDiscordClient client,
            ulong? fromUserId, int? limit, RequestOptions? options = null)
        {
        ...
        {
            var args = new GuildPruneParams(days, includeRoleIds?.ToArray() ?? Array.Empty<ulong>());
        ...
        public static async Task<IReadOnlyCollection<RestGuildUser>> SearchUsersAsync(IGuild guild, BaseDiscordClient client,
            string query, int? limit, RequestOptions? options = null)
        {
        ...
        public static IAsyncEnumerable<IReadOnlyCollection<RestAuditLogEntry>> GetAuditLogsAsync(IGuild guild, BaseDiscordClient client,
            ulong? from, int? limit, RequestOptions? options = null, ulong? userId = null, ActionType? actionType = null, ulong? afterId = null)
        {
        ...
        #region Webhooks
        public static async Task<RestWebhook?> GetWebhookAsync(IGuild guild, BaseDiscordClient client, ulong id, RequestOptions? options = null)
        {
        ...
        public static async Task<IReadOnlyCollection<RestWebhook>> GetWebhooksAsync(IGuild guild, BaseDiscordClient client, RequestOptions? options = null)
        {
        ...
        #region Emotes
        public static async Task<IReadOnlyCollection<GuildEmote>> GetEmotesAsync(IGuild guild, BaseDiscordClient client, RequestOptions? options = null)
        {
        ...
        public static async Task<GuildEmote?> GetEmoteAsync(IGuild guild, BaseDiscordClient client, ulong id, RequestOptions? options = null)
        {
            ...
            RequestOptions? options)
        {
            ...
            if (roles.IsSpecified)
                apiargs.RoleIds = roles.Value?.Select(xr => xr.Id)?.ToArray() ?? Array.Empty<ulong>();
            ...
            RequestOptions? options)
        {
            ...
            if (props.Roles.IsSpecified)
                apiargs.RoleIds = props.Roles.Value?.Select(xr => xr.Id)?.ToArray() ?? Array.Empty<ulong>();

            var emote = await client.ApiClient.ModifyGuildEmoteAsync(guild.Id, id, apiargs, options).ConfigureAwait(false);
            return emote.ToEntity();
        }
        public static Task DeleteEmoteAsync(IGuild guild, BaseDiscordClient client, ulong id, RequestOptions? options = null)
            => client.ApiClient.DeleteGuildEmoteAsync(guild.Id, id, options);

        public static Task<API.Sticker> CreateStickerAsync(BaseDiscordClient client, IGuild guild, string name, Image image, IEnumerable<string> tags,
        ...
        public static Task<API.Sticker> CreateStickerAsync(BaseDiscordClient client, IGuild guild, string name, Stream stream, string filename, IEnumerable<string> tags,
            string? description = null, RequestOptions? options = null)
        {
            string tagString;
            try
            {
                Preconditions.NotNull(stream, nameof(stream));
                Preconditions.NotNull(filename, nameof(filename));

                name = StickerProperties.ValidateName(name);
                description = StickerProperties.ValidateDescription(description);

                tagString = StickerProperties.ValidateTagString(tags);
            }
            catch (Exception ex)
            {
                return Task.FromException<API.Sticker>(ex);
            }
        ...
        public static Task<API.Sticker> ModifyStickerAsync(BaseDiscordClient client, ulong guildId, ulong stickerId, Action<StickerProperties> func,
            RequestOptions? options = null)
        {
            if (func is null)
                return Task.FromException<API.Sticker>(new ArgumentNullException(nameof(func)));
            ...
            return client.ApiClient.ModifyStickerAsync(apiArgs, guildId, stickerId, options);
        }

        public static Task DeleteStickerAsync(BaseDiscordClient client, ulong guildId, ulong stickerId, RequestOptions? options = null)
            => client.ApiClient.DeleteStickerAsync(guildId, stickerId, options);
        #endregion
        ...
        {
            var models = await client.ApiClient.GetGuildScheduledEventUsersAsync(guildEvent.Id, guildEvent.GuildId, limit, options).ConfigureAwait(false);
            ...
            ulong? fromUserId, int? limit, RequestOptions? options = null)
        {
            return new PagedAsyncEnumerable<RestUser>(
                ...
                async (info, ct) =>
                {
                    ...
                    if (info.Position != null)
                        args.RelativeUserId = info.Position.Value;
                    var models = await client.ApiClient.GetGuildScheduledEventUsersAsync(guildEvent.Id, guildEvent.GuildId, args, options).ConfigureAwait(false);
                    return models
    ...
    IGuildScheduledEvent guildEvent, RequestOptions? options = null)
        {
            ...
            var apiArgs = new ModifyGuildScheduledEventParams()
            {
                ...
                Status = args.Status,
                Type = args.Type,
                Image = args.CoverImage.Map(x => x?.ToModel())
            };
            ...
            return client.ApiClient.ModifyGuildScheduledEventAsync(apiArgs, guildEvent.Id, guildEvent.GuildId, options);
        }

        public static Task<API.GuildScheduledEvent> ModifyGuildEventAsync(BaseDiscordClient client, Action<GuildScheduledEventsProperties> func,
            ulong guildId,
            ulong guildEventId, RequestOptions? options = null)
        {
            Preconditions.NotNull(func, nameof(func));
            ...
            return client.ApiClient.ModifyGuildScheduledEventAsync(apiArgs, guildEventId, guildId, options);
        }
        ...
        public static Task<GuildScheduledEvent> CreateGuildEventAsync(BaseDiscordClient client, IGuild guild,
            string name,
            ...
            RequestOptions? options = null)
        {
            ...
            {
                return Task.FromException<GuildScheduledEvent>(ex);
            }


            var apiArgs = new CreateGuildScheduledEventParams()
            {
                ChannelId = Optional.CreateFromNullable(channelId),
                Description = Optional.CreateFromNullable(description),
                EndTime = Optional.CreateFromNullable(endTime),
                Name = name,
            ...
            return client.ApiClient.CreateGuildScheduledEventAsync(apiArgs, guild.Id, options);
        }

        public static Task DeleteEventAsync(BaseDiscordClient client, ulong guildId, ulong guildEventId, RequestOptions? options = null)
            => client.ApiClient.DeleteGuildScheduledEventAsync(guildEventId, guildId, options);

        #endregion

        #region Welcome Screen

        public static async Task<WelcomeScreen?> GetWelcomeScreenAsync(IGuild guild, BaseDiscordClient client, RequestOptions? options = null)
        {
        ...
        public static async Task<WelcomeScreen?> ModifyWelcomeScreenAsync(bool enabled, string? description, WelcomeScreenChannelProperties[]? channels, IGuild guild, BaseDiscordClient client, RequestOptions? options = null)
        {
            ...
            var args = new ModifyGuildWelcomeScreenParams
            {
                Enabled = enabled,
                Description = Optional.CreateFromNullable(description),
                WelcomeChannels = Optional.CreateFromNullable(channels?.Select(ch => new API.WelcomeScreenChannel
                {
                    ChannelId = ch.Id,
        ...
        public static Task<AutoModerationRule> CreateAutoModRuleAsync(IGuild guild, Action<AutoModRuleProperties> func, BaseDiscordClient client, RequestOptions? options = null)
        {
            Preconditions.NotNull(func, nameof(func));
        ...
        public static Task<AutoModerationRule?> GetAutoModRuleAsync(ulong ruleId, IGuild guild, BaseDiscordClient client, RequestOptions? options = null)
            => client.ApiClient.GetGuildAutoModRuleAsync(guild.Id, ruleId, options);

        public static Task<AutoModerationRule[]> GetAutoModRulesAsync(IGuild guild, BaseDiscordClient client, RequestOptions? options = null)
            => client.ApiClient.GetGuildAutoModRulesAsync(guild.Id, options);

        public static Task<AutoModerationRule> ModifyRuleAsync(BaseDiscordClient client, IAutoModRule rule, Action<AutoModRuleProperties> func, RequestOptions? options = null)
        {
            Preconditions.NotNull(func, nameof(func));
        ...
        public static Task DeleteRuleAsync(BaseDiscordClient client, IAutoModRule rule, RequestOptions? options = null)
            => client.ApiClient.DeleteGuildAutoModRuleAsync(rule.GuildId, rule.Id, options);
        #endregion

        #region Onboarding

        public static Task<GuildOnboarding> GetGuildOnboardingAsync(IGuild guild, BaseDiscordClient client, RequestOptions? options = null)
