...
/// </summary>
public partial class AutoModRuleDeletedAuditLogData : IAuditLogData
{
    ...
    internal static AutoModRuleDeletedAuditLogData Create(BaseDiscordClient discord, EntryModel entry)
    {
