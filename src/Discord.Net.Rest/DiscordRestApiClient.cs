...
namespace Discord.API
{
    internal class DiscordRestApiClient : IDisposable, IAsyncDisposable
    {
        ...
        public Task<Channel> CreatePostAsync(ulong channelId, CreateMultipartPostAsync args, RequestOptions? options = null)
        {
            ...
            return SendMultipartAsync<Channel>("POST", () => $"channels/{channelId}/threads", args.ToDictionary(this.SerializerOptions), bucket, options: options);
        }
        ...
        {
            Preconditions.NotEqual(channelId, 0UL, nameof(channelId));
            Preconditions.NotEqual(messageId, 0UL, nameof(messageId));
        ...
        {
            Preconditions.NotEqual(channelId, 0UL, nameof(channelId));
            Preconditions.NotEqual(userId, 0UL, nameof(channelId));
        ...
        {
            Preconditions.NotEqual(channelId, 0UL, nameof(channelId));
            Preconditions.NotEqual(userId, 0UL, nameof(userId));
        ...
        public Task AddRoleAsync(ulong guildId, ulong userId, ulong roleId, RequestOptions? options = null)
        {
            Preconditions.NotEqual(guildId, 0UL, nameof(guildId));
            Preconditions.NotEqual(userId, 0UL, nameof(userId));
            Preconditions.NotEqual(roleId, 0UL, nameof(roleId));
        ...
        public async Task ModifyWebhookMessageAsync(ulong webhookId, ulong messageId, ModifyWebhookMessageParams args, RequestOptions? options = null, ulong? threadId = null)
        {
            ...
            Preconditions.NotNull(args, nameof(args));
            Preconditions.NotEqual(webhookId, 0UL, nameof(webhookId));
            Preconditions.NotEqual(messageId, 0UL, nameof(messageId));
        ...
        public Task ModifyWebhookMessageAsync(ulong webhookId, ulong messageId, UploadWebhookFileParams args, RequestOptions? options = null, ulong? threadId = null)
        {
            ...
            var ids = new BucketIds(webhookId: webhookId);
            return SendMultipartAsync<Message>("PATCH", () => $"webhooks/{webhookId}/{AuthToken}/messages/{messageId}?{WebhookQuery(false, threadId)}", args.ToDictionary(this.SerializerOptions), ids, clientBucket: ClientBucketType.SendEdit, options: options);
        }
        ...
        public Task<Message> UploadFileAsync(ulong channelId, UploadFileParams args, RequestOptions? options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            return SendMultipartAsync<Message>("POST", () => $"channels/{channelId}/messages", args.ToDictionary(this.SerializerOptions), ids, clientBucket: ClientBucketType.SendEdit, options: options);
        }
        ...
        public Task<Message> UploadWebhookFileAsync(ulong webhookId, UploadWebhookFileParams args, RequestOptions? options = null, ulong? threadId = null)
        {
            ...
            var ids = new BucketIds(webhookId: webhookId);
            return SendMultipartAsync<Message>("POST", () => $"webhooks/{webhookId}/{AuthToken}?{WebhookQuery(true, threadId)}", args.ToDictionary(this.SerializerOptions), ids, clientBucket: ClientBucketType.SendEdit, options: options);
        }
        ...
        public Task<Message> ModifyMessageAsync(ulong channelId, ulong messageId, Rest.UploadFileParams args, RequestOptions? options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            return SendMultipartAsync<Message>("PATCH", () => $"channels/{channelId}/messages/{messageId}", args.ToDictionary(this.SerializerOptions), ids, clientBucket: ClientBucketType.SendEdit, options: options);
        }
        #endregion
        ...
        {
            Preconditions.NotEqual(id, 0UL, nameof(id));
        ...
        public Task<Sticker> ModifyStickerAsync(ModifyStickerParams args, ulong guildId, ulong stickerId, RequestOptions? options = null)
        {
            Preconditions.NotNull(args, nameof(args));
            Preconditions.NotEqual(guildId, 0UL, nameof(guildId));
            Preconditions.NotEqual(stickerId, 0UL, nameof(stickerId));
        ...
        public Task<IReadOnlyCollection<User>> GetReactionUsersAsync(ulong channelId, ulong messageId, string emoji, GetReactionUsersParams args, ReactionType reactionType, RequestOptions? options = null)
        {
            ...
            Preconditions.GreaterThan(args.AfterUserId, 0UL, nameof(args.AfterUserId));
            options = RequestOptions.CreateOrClone(options);
        ...
        {
            Preconditions.NotEqual(newsChannelId, 0UL, nameof(newsChannelId));
            Preconditions.NotEqual(followingChannelId, 0UL, nameof(followingChannelId));
            options = RequestOptions.CreateOrClone(options);
        ...
        {
            Preconditions.NotEqual(channelId, 0UL, nameof(channelId));
            Preconditions.NotEqual(targetId, 0UL, nameof(targetId));
            Preconditions.NotNull(args, nameof(args));
            options = RequestOptions.CreateOrClone(options);
        ...
        {
            Preconditions.GreaterThan(channelId, 0UL, nameof(channelId));
            Preconditions.GreaterThan(messageId, 0UL, nameof(messageId));
            options = RequestOptions.CreateOrClone(options);
        ...
        {
            Preconditions.GreaterThan(channelId, 0UL, nameof(channelId));
            Preconditions.GreaterThan(userId, 0UL, nameof(userId));
            options = RequestOptions.CreateOrClone(options);
        ...
        public Task<ApplicationCommand[]> GetGlobalApplicationCommandsAsync(bool withLocalizations = false, string? locale = null, RequestOptions? options = null)
        {
            ...
            return SendAsync<ApplicationCommand[]>("GET", () => $"applications/{CurrentApplicationId}/commands{query}",
                new BucketIds(), options: options);
        }
        ...
        public Task<ApplicationCommand[]> GetGuildApplicationCommandsAsync(ulong guildId, bool withLocalizations = false, string? locale = null, RequestOptions? options = null)
        {
            ...
            //with_localizations=false doesn't return localized names and descriptions
            var query = withLocalizations ? "?with_localizations=true" : string.Empty;
            return SendAsync<ApplicationCommand[]>("GET", () => $"applications/{CurrentApplicationId}/guilds/{guildId}/commands{query}",
        ...
        public Task CreateInteractionResponseAsync(UploadInteractionFileParams response, ulong interactionId, string interactionToken, RequestOptions? options = null)
        {
            ...
            var ids = new BucketIds();
            return SendMultipartAsync("POST", () => $"interactions/{interactionId}/{interactionToken}/callback", response.ToDictionary(this.SerializerOptions), ids, clientBucket: ClientBucketType.SendEdit, options: options);
        }
        ...
        public Task<Message> ModifyInteractionResponseAsync(UploadWebhookFileParams args, string interactionToken, RequestOptions? options = null)
        {
            ...
            return SendMultipartAsync<Message>("PATCH", () => $"webhooks/{CurrentApplicationId}/{interactionToken}/messages/@original", args.ToDictionary(this.SerializerOptions), new BucketIds(), options: options);
        }
        ...
        public Task<Message> CreateInteractionFollowupMessageAsync(CreateWebhookMessageParams args, string token, RequestOptions? options = null)
        {
            ...
            if (!args.File.IsSpecified)
                ...
                return SendMultipartAsync<Message>("POST", () => $"webhooks/{CurrentApplicationId}/{token}?wait=true", args.ToDictionary(this.SerializerOptions), new BucketIds(), options: options);
        }
        ...
        public Task<Message> CreateInteractionFollowupMessageAsync(UploadWebhookFileParams args, string token, RequestOptions? options = null)
        {
            ...
            var ids = new BucketIds();
            return SendMultipartAsync<Message>("POST", () => $"webhooks/{CurrentApplicationId}/{token}?wait=true", args.ToDictionary(this.SerializerOptions), ids, clientBucket: ClientBucketType.SendEdit, options: options);
        }
        ...
        {
            Preconditions.NotEqual(guildId, 0UL, nameof(guildId));
            Preconditions.NotEqual(commandId, 0UL, nameof(commandId));
        ...
        public Task<Guild> ModifyGuildAsync(ulong guildId, Rest.ModifyGuildParams args, RequestOptions? options = null)
        {
            Preconditions.NotEqual(guildId, 0UL, nameof(guildId));
            Preconditions.NotNull(args, nameof(args));
            Preconditions.NotEqual(args.AfkChannelId, 0UL, nameof(args.AfkChannelId));
            Preconditions.AtLeast(args.AfkTimeout, 0, nameof(args.AfkTimeout));
            Preconditions.NotNullOrEmpty(args.Name, nameof(args.Name));
            Preconditions.GreaterThan(args.OwnerId, 0UL, nameof(args.OwnerId));
        ...
        public Task<GuildIncidentsData> ModifyGuildIncidentActionsAsync(ulong guildId, ModifyGuildIncidentsDataParams args, RequestOptions? options = null)
        {
            ...
            return SendJsonAsync<GuildIncidentsData>("PUT", () => $"guilds/{guildId}/incident-actions", args, ids, options: options);
        }
        #endregion
        ...
        public Task CreateGuildBanAsync(ulong guildId, ulong userId, CreateGuildBanParams args, RequestOptions? options = null)
        {
            ...
            var ids = new BucketIds(guildId: guildId);
            if (!string.IsNullOrWhiteSpace(args.Reason.GetValueOrDefault()))
                options.AuditLogReason = args.Reason.GetValueOrDefault();
        ...
        {
            Preconditions.NotEqual(guildId, 0UL, nameof(guildId));
            Preconditions.NotEqual(integrationId, 0UL, nameof(integrationId));
            options = RequestOptions.CreateOrClone(options);
        ...
        public Task<InviteMetadata> CreateChannelInviteAsync(ulong channelId, CreateChannelInviteParams args, RequestOptions? options = null)
        {
            ...
            if (args.TargetType.IsSpecified)
            {
                ...
                if (args.TargetType.Value == TargetUserType.Stream)
                    Preconditions.GreaterThan(args.TargetUserId, 0UL, nameof(args.TargetUserId));
                if (args.TargetType.Value == TargetUserType.EmbeddedApplication)
                    Preconditions.GreaterThan(args.TargetApplicationId, 0UL, nameof(args.TargetApplicationId));
            }
            options = RequestOptions.CreateOrClone(options);
        ...
        public Task<Role> ModifyGuildRoleAsync(ulong guildId, ulong roleId, Rest.ModifyGuildRoleParams args, RequestOptions? options = null)
        {
            ...
            Preconditions.NotEqual(roleId, 0UL, nameof(roleId));
            Preconditions.NotNull(args, nameof(args));
            Preconditions.AtLeast(args.Color.GetValueOrDefault(0), 0U, nameof(args.Color));
            Preconditions.NotNullOrEmpty(args.Name, nameof(args.Name));
            options = RequestOptions.CreateOrClone(options);
        ...
        {
            Preconditions.NotEqual(guildId, 0UL, nameof(guildId));
            Preconditions.NotEqual(emoteId, 0UL, nameof(emoteId));
            options = RequestOptions.CreateOrClone(options);
        ...
        {
            Preconditions.NotEqual(guildId, 0UL, nameof(guildId));
            Preconditions.NotEqual(eventId, 0UL, nameof(eventId));
            options = RequestOptions.CreateOrClone(options);

            var ids = new BucketIds(guildId: guildId);

            return NullifyNotFound(SendAsync<GuildScheduledEvent>("GET", () => $"guilds/{guildId}/scheduled-events/{eventId}?with_user_count=true", ids, options: options));
        }
        ...
        {
            Preconditions.NotEqual(guildId, 0UL, nameof(guildId));
            Preconditions.NotEqual(ruleId, 0UL, nameof(ruleId));
        ...
        public Task<GuildOnboarding> GetGuildOnboardingAsync(ulong guildId, RequestOptions? options = null)
        {
            Preconditions.NotEqual(guildId, 0UL, nameof(guildId));
        ...
        public Task<IReadOnlyCollection<UserGuild>> GetMyGuildsAsync(GetGuildSummariesParams args, RequestOptions? options = null)
        {
            ...
            Preconditions.GreaterThan(args.AfterGuildId, 0UL, nameof(args.AfterGuildId));
            options = RequestOptions.CreateOrClone(options);
        ...
        {
            Preconditions.NotNull(args, nameof(args));
            Preconditions.GreaterThan(args.RecipientId, 0UL, nameof(args.RecipientId));
            options = RequestOptions.CreateOrClone(options);
        ...
        {
            return JsonSerializer.Serialize(value, value?.GetType() ?? typeof(object), this.SerializerOptions);
        }
        protected T DeserializeJson<T>(Stream jsonStream)
        {
            return JsonSerializer.Deserialize<T>(jsonStream, this.SerializerOptions)!;
        }
        ...
        private static BucketId GetBucketId(string httpMethod, BucketIds ids, Expression<Func<string>> endpointExpr, string? callingMethod)
        {
            ...
            return _bucketIdGenerators.GetOrAdd(callingMethod ?? "Unknown", x => CreateBucketId(endpointExpr))(ids);
        }
        ...
        private static Func<BucketIds, BucketId> CreateBucketId(Expression<Func<string>> endpoint)
        {
            try
            {
                ...
                if (endpoint.Body.NodeType == ExpressionType.Constant)
                    return x => BucketId.Create(x.HttpMethod, ((ConstantExpression)endpoint.Body).Value?.ToString()!, x.ToMajorParametersDictionary());

                var builder = new StringBuilder();
                var methodCall = (MethodCallExpression)endpoint.Body;
                var methodArgs = methodCall.Arguments.ToArray();
                string format = (string)(((ConstantExpression)methodArgs[0]).Value)!;
                ...
                {
                    var arrayExpr = (NewArrayExpression)methodArgs[1];
