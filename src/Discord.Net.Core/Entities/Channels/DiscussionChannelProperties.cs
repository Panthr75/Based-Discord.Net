...
public class DiscussionChannelProperties : TextChannelProperties
{
    ...
    /// </summary>
    /// <remarks>
    ///     Not available in discussion channels.
    /// </remarks>
    public new Optional<int> SlowModeInterval { get; }

    /// <summary>
    /// Gets or sets rate limit on creating posts in this discussion channel.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets or sets a collection of tags inside of this discussion channel.
    /// </summary>
    public Optional<IEnumerable<ForumTagProperties>> Tags { get; set; }

    /// <summary>
    /// Gets or sets a new default reaction emoji in this discussion channel.
    /// </summary>
    public Optional<IEmote> DefaultReactionEmoji { get; set; }

    /// <summary>
    /// Gets or sets the rule used to order posts in discussion channels.
    /// </summary>
