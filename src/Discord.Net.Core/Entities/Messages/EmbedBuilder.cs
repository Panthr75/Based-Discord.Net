...
namespace Discord
{
    ...
    public class EmbedBuilder : IEquatable<EmbedBuilder>
    {
        ...
        {
            get => _thumbnail?.Url;
            set => _thumbnail = value is null ? null : new EmbedThumbnail(value, null, null, null);
        }
        ...
        {
            get => _image?.Url;
            set => _image = value is null ? null : new EmbedImage(value, null, null, null);
        }
        ...
        /// <returns></returns>
        public bool Equals([NotNullWhen(true)] EmbedBuilder? embedBuilder)
        {
    ...
    public class EmbedFieldBuilder
    {
        ...
        public EmbedField Build()
            => new(Name, Value.ToString()!, IsInline);
        ...
        /// <returns></returns>
        public bool Equals([NotNullWhen(true)] EmbedFieldBuilder? embedFieldBuilder)
        ...
        {
            return HashCode.Combine(this._name ?? string.Empty, this._value ?? string.Empty, this.IsInline);
        }
    }
    ...
    public class EmbedAuthorBuilder
    {
        ...
        /// <returns></returns>
        public bool Equals([NotNullWhen(true)] EmbedAuthorBuilder? embedAuthorBuilder)
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(this._name, this.Url ?? string.Empty, this.IconUrl ?? string.Empty);
        }
    }
    ...
    public class EmbedFooterBuilder
    {
        ...
        /// <returns></returns>
        public bool Equals([NotNullWhen(true)] EmbedFooterBuilder? embedFooterBuilder)
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(this.Text, this.IconUrl ?? string.Empty);
        }
    }
}
